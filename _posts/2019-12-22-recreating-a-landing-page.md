...
![React Training Screenshot]({{site.url}}/images/react-training-screenshot.png)
...
![Colorzilla Chrome Extension]({{site.url}}/images/colorzilla.png)
...
![Background Shapes]({{site.url}}/images/background-shapes.png)
...
![My background shapes in SVG]({{site.url}}/images/my-shapes.png)
...
![My version of the logo]({{site.url}}/images/react-training-logo.png)
...
![View for large screen sizes]({{site.url}}/images/large_screen.png)
...
![Footer with CSS Grid]({{site.url}}/images/footer.png)
